...
The catalogue is shared with the runner, which keeps the same eleven keys in
...
CATALOGUE = {
    ...
    'runner.chat': 'the chat assistant (questions about defects, runs and suites; running a saved case from it)',
